...
final class UserManager {
    ...
    private func userFavoriteProductCollection(userId: String, favoriteProduct: String) -> DocumentReference {
        userFavoriteProductCollection(userId: userId).document(favoriteProduct)
    }
...
//            decoder.keyDecodingStrategy = .convertFromSnakeCase
    ...
    func removeUserFavoriteProduct(userId: String, FavoriteProductId: String) async throws {
        try await userFavoriteProductCollection(userId: userId, favoriteProduct: FavoriteProductId).delete()
    }
